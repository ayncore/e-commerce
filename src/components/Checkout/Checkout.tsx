...
import pro from "@/Images/products/9.png"
import pro1 from "@/Images/products/8.png"
import pro2 from "@/Images/products/10.png"
...
const Checkout = () => {
    return (
        ...
        <div className="sm:flex shadow-md my-10">
          ...
          <div id="summary" className=" w-full   sm:w-1/4   md:w-1/2  dark:bg-white    px-8 py-10">
